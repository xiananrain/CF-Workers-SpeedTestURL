...
例如您的项目域名为 `CloudflareST.exe -tp 443 -f ip.txt -n 200 -dn 10 -sl 8 -url https://speed.xianan.cloudns.org/1g`
...
- 1024K  测试下载地址: `https://speed.xianan.cloudns.org/1024k`
- 200M   测试下载地址: `https://speed.xianan.cloudns.org/200m`
- 1G     测试下载地址: `https://speed.xianan.cloudns.org/1g`
